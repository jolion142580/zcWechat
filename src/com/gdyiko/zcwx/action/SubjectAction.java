...
//	@Resource(name = "propertieService")
	...
	public String findByAll() throws JSONException, IOException{

		propertieService=new PropertieService();
		String subjectURL = propertieService.getPropertie("configurePath")+"/subject!find";
