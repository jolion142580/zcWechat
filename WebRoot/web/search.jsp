 ...
 <script type="text/javascript">
  ...
  <body>
    <div class="header titlebar">
		<a href="web/Index.jsp" jslink="web/Index.jsp" class="btn_back link_checkJump"><span class="ic ic_back"></span></a>
		<div class="searchInput" style="width: 781px;">
			<span class="ic ic_search"></span>
			<input type="text" placeholder="搜索事项名称…" class='numkeyboard'  data-bind="value:keyword,textInput: keyword" style="width: 701px;">
	...
	<div class="contain content_allForm content_result" style="height: 588px;">
		...
		<div class="content content_subcontent transition" style="touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); left: 100%;">
			<div id="searchResult" class="content content_imgcontent content_imgcontent_search" style="display: none;"> <!-- style="display: none;" -->
				<div class="content_review" zoomx="1">
