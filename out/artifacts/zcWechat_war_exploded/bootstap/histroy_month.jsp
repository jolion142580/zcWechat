    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container" >
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-graph">月度业务分类数据统计（点击柱状图查看详情）</span>
                    </div>
                    <div class="mws-panel-body">
...
function myJS(value){
	...
	ajaxXmlDay(id,year,month,value);
	///
	$("#mws-jui-dialog").dialog({
		autoOpen: false, 
		title: "本业务"+year+"年"+month+"月的各日业务量", 
		modal: true, 
		width: 800, 
		buttons: [{
				text: "关闭", 
...
function getChart1(dataString) {
		...
		var jsondata ='{"chart": {"showpercentvalues": "1","showlegend": "1","showlabels": "1","showvalues": "1","showpercentageinlabel": "1","formatNumberScale": "0"},"data": '+dataString+'}';
...
function getChart2(dataString) {
		if  ( FusionCharts( "chartId2" ) )  FusionCharts( "chartId2" ).dispose();
		var jsondata ='{"chart": {"bgcolor": "406181, 6DA5DB","bgalpha": "100","basefontcolor": "FFFFFF","canvasbgalpha": "0","canvasbordercolor": "FFFFFF","divlinecolor": "#FF1493","divlinealpha": "100","numvdivlines": "10","vdivlineisdashed": "1","showalternatevgridcolor": "1","linecolor": "BBDA00","anchorradius": "4","anchorbgcolor": "BBDA00","anchorbordercolor": "FFFFFF","anchorborderthickness": "2","showvalues":"1","tooltipbgcolor": "406181","tooltipbordercolor": "406181","alternatehgridalpha": "5","unescapeLinks":"0","howalternatevgridcolor":"1"},"data": '+dataString+'}';
		var d = document.getElementById("chart_more");
		var width = d.offsetWidth ;
		var height = d.offsetHeight ;
		var chart = new FusionCharts("easyui/FusionCharts_XT_Evaluation/Charts/Line.swf","chartId2",
				width, height, "0", "0");
		chart.setJSONData( jsondata );
...
function ajaxXml(id,year,month){
  ...
  $.ajax({   
          type:"POST",  
         url:"QueueHist!getServerTypeMonthCountByTodayJson.action?year="+year+"&address="+id+"&month="+month,  
           dataType:"text",  
...
function ajaxXmlDay(id,year,month,name){
	//获得狮山情况

    $.ajax({   
          type:"POST",  
          url:"QueueHist!getonlyServerDay.action?year="+year+"&address="+id+"&month="+month+"&name="+name,  
           dataType:"text",  
          success:function(result){   //function1()
			///alert(datastr)
			getChart2(result);
