    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container" >
				<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-month-calendar">时间段选择</span>
                    </div>
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-graph">区域比较统计（点击曲线标点查看详情）</span>
                    </div>
                    <div class="mws-panel-body">
            ...
            <div id="mws-jui-dialog" >
                <div id="chart2" style="width:100%; height:370px;background:"></div>
            </div>
            <!-- Footer -->
            <div id="mws-footer">
...
function myJS(value,value1){
	var id = $(".current").attr("id");
    var year = $(".selector").val();
	ajaxServerXml(value1,year,value);
	///
	$("#mws-jui-dialog").dialog({
		autoOpen: false, 
		title: year+"年该时段平均业务量", 
		modal: true, 
		width: 1000, 
		buttons: [{
				text: "关闭", 
...
function getChart1(dataString) {
		...
		var chart = new FusionCharts("easyui/FusionCharts_XT_Evaluation/Charts/StackedArea2D.swf","chartId",width, height, "0", "0");
...
function ajaxXml(id,year){
  ...
  $.ajax({   
          type:"POST",  
         url:"QueueHist!getBusinessCountJson.action?year="+year+"&address="+id,  
           dataType:"text",  
...
function ajaxServerXml(value1,year,value){
	//获得狮山情况
  $.ajax({   
          type:"POST",  
         url:"QueueHist!getTimeServer.action?year="+year+"&name="+value+"&address="+value1,  
           dataType:"text",  
          success:function(result){   //function1()
			///alert(datastr);
			getChart2(result);
