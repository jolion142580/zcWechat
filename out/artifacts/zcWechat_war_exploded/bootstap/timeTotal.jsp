	...
	<!-- Header Wrapper -->
            ...
            <div class="container" width="100%">
				...
				<div class="mws-report-container clearfix" style="padding-top:15px">
                    ...
                    <a class="mws-report" href="#" onClick="showlist4('someday')">
                    	<span class="mws-report-icon mws-ic ic-date-magnify"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text" id="SomeTimetext">所选时间段检测：</span>
                            <span class="mws-report-value" id="SomeTime">0</span>
                        </span>
                    </a>  
                	<a class="mws-report" href="#">
                    	<span class="mws-report-icon mws-ic ic-chart-pie"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text">时间段完成率：</span>
                            <span class="mws-report-value" id="finish" >0%</span>
                        </span>
                    </a>
                    <a class="mws-report" href="#" onClick="showlist4('somedaybuhege')">
                    	<span class="mws-report-icon mws-ic ic-accept"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text">时间段合格率：</span>
    ...
    $.ajax({   
         ...
         data:{
          ...
          success:function(result){
			...
			document.getElementById("SomeTime").innerText=list[6].value;
...
function showlist4(x){
			...
			if(x=='day'){
		        ...
		        year = document.getElementById('startTime').value;
			    month = document.getElementById('endTime').value;
				str1 = 'time';
			}else if(x=='somedaybuhege'){
		        year = document.getElementById('startTime').value;
			    month = document.getElementById('endTime').value;
				str1 = 'time';
				str = 'buhege';
