            ...
            <div class="container" width="90%">
			    ...
			    <div class="mws-report-container clearfix" style="padding-top:15px">
                	...
                	<a class="mws-report" href="#" onClick="showlist4('year')">
                     ...
                     <a class="mws-report" href="#" onClick="showlist4('somemonth')">
                    	<span class="mws-report-icon mws-ic ic-date-magnify"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text" id="SomeMonthtext">某月合计：</span>
                            <span class="mws-report-value" id="SomeMonth">0</span>
                        </span>
                    </a>                   
                	<a class="mws-report" href="#">
                    	<span class="mws-report-icon mws-ic ic-chart-pie"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text" id="monthfinishtext">所选月份完成率：</span>
                            <span class="mws-report-value" id="finish" >0%</span>
                        </span>
                    </a>
                    <a class="mws-report" href="#" onClick="showlist4('somemonthbuhege')">
                    	<span class="mws-report-icon mws-ic ic-accept"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text" id="monthhegetext">所选月份合格率：</span>
...
function ajaxXml(year1,month1,area1,danwei){
	//获得基本情况
		document.getElementById("monthfinishtext").innerText = month1+"月份完成率";
		document.getElementById("monthhegetext").innerText = month1+"月份合格率";
	    document.getElementById("SomeMonthtext").innerText = month1+"月份检测：";
	  $.ajax({   
          type:"POST",  
         url:"../report!getMonthTotalJson.action",  
         data:{
             year:year1,
             area:area1,
             month:month1,
    ...
    $.ajax({   
          type:"POST",  
         url:"../report!getUserMonthTestJson",  
         data:{
             year:year1,
             area:area1,
             month:month1,
          ...
          success:function(result){
			...
			document.getElementById("SomeMonth").innerText=list[6].value;
...
function getExcel(){
	    var year = $(".selector").val();
        var month = $(".selectormonth").val();
        window.open("../report!demoExcel?year="+year+"&month="+month+"&area=month");
} 
//弹出完成值列表
function showlist1(){
	        var str = '';
...
function showlist4(x){
			...
			if(x=='day'){
				...
				year = $(".selector").val();
				month = $(".selectormonth").val();
				str1 = 'month';
			}else if(x=='somemonthbuhege'){
				year = $(".selector").val();
				month = $(".selectormonth").val();
				str1 = 'month';
				str = 'buhege';
