...
<div class="page-group">
    <div class="page page-current">
        <header class="bar bar-nav"
            ...
            <a class="button button-link button-nav pull-left" href="web!complaint">
        ...
        <%-- <div align="center" style="line-height:25px;">
             <div align="center"
                 ...
                 <span style="font-size:12px;">张槎街道行政服务中心授权使用&nbsp;&nbsp;南邮信息联合开发</span></div>
         </div>--%>
        ...
        $.ajax(
            {
                ...
                success: function (data) {
                    alert("留言成功");
                    window.location = "<%=basePath%>web!complaint";
                    // location.reload();
                    return;
                },
                error: function () {
