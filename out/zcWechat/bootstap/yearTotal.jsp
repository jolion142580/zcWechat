	...
	<!-- Header Wrapper -->
            ...
            <div class="container" width="100%">
				...
				<div class="mws-report-container clearfix" style="padding-top:15px">
                	<a class="mws-report" href="#" onClick="showlist4('day')">
                	...
                	<a class="mws-report" href="#" onClick="showlist4('month')">
                	...
                	<a class="mws-report" href="#" onClick="showlist4('year')">
                    	<span class="mws-report-icon mws-ic ic-date-magnify"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text">本年合计：</span>
                            <span class="mws-report-value" id="thisYear">0</span>
                        </span>
                    </a>
                    <a class="mws-report" href="#" onClick="showlist4('someyear')">
                    	<span class="mws-report-icon mws-ic ic-date-magnify"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text" id="Someyeartext">本年合计：</span>
                            <span class="mws-report-value" id="SomeYear">0</span>
                        </span>
                    </a>
                	<a class="mws-report" href="#">
                    	<span class="mws-report-icon mws-ic ic-chart-pie"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text" id="yearfinishtext">所选年份完成率：</span>
                            <span class="mws-report-value" id="finish" >0%</span>
                        </span>
                    </a>
                    <a class="mws-report" href="#" onClick="showlist4('someyearbuhege')">
                    	<span class="mws-report-icon mws-ic ic-accept"></span>
                        <span class="mws-report-content">
                        	<span class="mws-report-title big_text" id="yearhegetext">所选年份合格率：</span>
...
//异步读取数据
function ajaxXml(year1,area1,danwei){
	//获得基本情况
	    document.getElementById("yearfinishtext").innerText = year1+"年完成率：";
		document.getElementById("yearhegetext").innerText = year1+"年合格率：";
		document.getElementById("Someyeartext").innerText = year1+"年检测：";
	  $.ajax({   
          type:"POST",  
         url:"../report!getYearTotalJson.action",  
         data:{
             year:year1,
             area:area1,
             type:danwei
    ...
    $.ajax({   
         ...
         data:{
          ...
          success:function(result){
			...
			document.getElementById("SomeYear").innerText=list[6].value;
...
function getExcel(){
	           var year = $(".selector").val();
               var month = "";
               window.open("../report!demoExcel?year="+year+"&month="+month+"&area=year");
} 
//弹出完成值列表
function showlist1(){
	        var str = '';
